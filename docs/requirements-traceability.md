...
1. 구현: JSON 응답 협상을 핸들러 실행 전에 확정하는 [메뉴](../src/main/java/com/example/coffeeordersystem/menu/api/MenuController.java)·[포인트](../src/main/java/com/example/coffeeordersystem/point/PointController.java)·[주문](../src/main/java/com/example/coffeeordersystem/order/OrderController.java) 매핑, DB 시간 정밀도의 [인기 메뉴 구간](../src/main/java/com/example/coffeeordersystem/menu/domain/PopularMenuWindow.java), 엄격한 [Outbox 워커 설정](../src/main/java/com/example/coffeeordersystem/outbox/OutboxWorkerConfiguration.java), [Claude autodev 포인터](../.claude/skills/autodev), 하네스 변경도 테스트를 다시 실행하게 하는 [Gradle 외부 입력](../build.gradle)
