...
| [0026](./0026-refine-feature-first-layered-architecture.md) | 기능 우선 계층형 아키텍처와 공개 Facade 경계 구체화 | 승인됨 |
| [0027](./0027-use-lombok-with-restrictions.md) | Lombok을 제한적으로 사용 | 승인됨 |
...
ADR 0026은 ADR 0006을 대체하지 않고 기능 내부 계층, 공개 Application 계약과 Facade 규칙을 구체화한다.
