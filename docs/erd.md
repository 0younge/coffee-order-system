...
다음 SQL은 물리 DDL이 아니라 트랜잭션 의도를 보여주는 개념 예시다. 워커는 활성 배치가 없을 때 기본 1초마다 실행하고 최대 50건을 선점한다.
...
- [ADR-0012: JWT 구현에 Spring Security 사용](./adr/0012-use-spring-security-for-jwt.md)
